...
def main():
    ...
    clusterPassword = os.getenv('mongodb+srv://bruno:Rodrigues02git@cluster0.wayqb.mongodb.net/')  # Pega a senha do cluster a partir das variáveis de ambiente
    try:  # Tenta conectar ao cluster MongoDB
        #client = MongoClient(f'') (Conexão mais segura)
        client = MongoClient(f'') # Conexão mais simples
